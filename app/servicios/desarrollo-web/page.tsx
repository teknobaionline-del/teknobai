...
import { Globe, ArrowRight, CheckCircle, Zap, Shield, Star } from "lucide-react";
    ...
    <main className="min-h-screen bg-void text-white">
      ...
      <section className="py-20 max-w-4xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            "Adaptado a móvil y tablet (responsive)",
      ...
      <section className="py-20 bg-ink/40">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="font-display text-3xl font-bold text-white mb-10 text-center">¿Por qué TeknoBai?</h2>
          <div className="grid sm:grid-cols-3 gap-5">
            {[
              { icon: Zap, title: "Rápido", desc: "Tu web lista en menos de 14 días sin perder calidad." },
              { icon: Shield, title: "Seguro", desc: "Precio cerrado desde el día uno. Sin sorpresas." },
              { icon: Star, title: "Premium", desc: "Diseño al nivel de las mejores marcas del mundo." },
            ].map((item) => {
